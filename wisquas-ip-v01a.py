...
def helpme():
    ...
    print ("./wisquas-v1.py -1 'https://IPADDRESS/dir1/dir2/otherstuff/'\n")
    print ("Using 'Mobile Browser' profile...")
    print ("./wisquas-v1.py -2 'https://IPADDRESS/dir1/dir2/otherstuff/'")
    sys.exit()
...
print("-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-")
print("-    Wis Quas (IP) - Level 6 - REVEAL   -")
...
print "=============================================================="
allhosts = [host_ip, 'localhost', '127.0.0.1', '127.0.1.1', 'null', 'test', '0', '-1', 'admin', 'root']
